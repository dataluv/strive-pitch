      ...
      <header className="h-12 bg-white border-b border-gray-200 px-5 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-3">
          ...
          <nav className="flex items-center gap-1 ml-4">
            <a href="/" className="px-3 py-1.5 text-sm text-gray-500 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors">Demo</a>
          ...
          <div className="bg-white border-t border-gray-200 p-4 shrink-0">
            <div className="max-w-3xl mx-auto flex items-center gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#00B894] focus:ring-2 focus:ring-[#00B894]/20"
              />
              <button
                onClick={() => sendMessage(input)}
                disabled={thinking || !input.trim()}
                className="px-5 py-3 bg-[#00B894] text-white rounded-xl text-sm font-semibold hover:bg-[#00a383] transition-colors disabled:opacity-50"
              >
                Send
              </button>
            </div>
